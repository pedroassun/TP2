...
void cardapio(){
    ...
    cout << "Suco.......\t" << "1" << "\t\t\tR$ 2,00" << endl;
    cout << "Hambúrguer.\t" << "2" << "\t\t\tR$ 6,00" << endl;
    cout << "Pizza......\t" << "3" << "\t\t\tR$ 10,00" << endl;
    cout << "Misto......\t" << "4" << "\t\t\tR$ 3,00" << endl << endl;
...
void Menu(Pedido *pi, TPilha *pilha){
    ...
    case 1:
        ...
        cin >> quantidade;
        while(quantidade <= 0) { // Exige pelo menos 1 unidade
...
void consulta(Pedido *pi, TPilha *p){
    ...
    cin >> cod;
     for (int i = p->Topo; i > 0; i--){
         if(cod == pi->codigo){
            cout << "Código do pedido: " << pi->codigo << "\n";
            cout << "Valor total do pedido: R$ " << p->Pilha[i].valor_pedido << "\n";
         }
